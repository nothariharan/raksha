...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      (glContext as any).clearColor(0, 0, 0, 0);
      (glContext as any).enable((glContext as any).BLEND);
      (glContext as any).blendFunc((glContext as any).SRC_ALPHA, (glContext as any).ONE_MINUS_SRC_ALPHA);
      ...
      const update = (t: number) => {
        ...
        if (rendererInstance && glContext) {
          (glContext as any).clear((glContext as any).COLOR_BUFFER_BIT | (glContext as any).DEPTH_BUFFER_BIT);
