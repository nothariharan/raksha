 ...
 * Features 4 channel cards (Call, WhatsApp, Web, AI Agents with 11 authentic AI logos from thesvg.org) and 4 trust value props.
 */

export function renderChannelContinuityHtml(): string {
  // 11 Official Brand AI SVGs with authentic brand colors (from thesvg.org / brand assets)
  
  // 1. OpenAI / ChatGPT (Official #10A37F)
  const openaiSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" fill="#10A37F" title="OpenAI / ChatGPT">
  ...
  // 2. Anthropic Claude (Official #D97706 / Terracotta #CC785C)
  const claudeSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" fill="#D97706" title="Anthropic / Claude">
  ...
  // 3. Google Gemini (Official 4-point Star Gradient #1A73E8 -> #9333EA)
  const geminiSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Google Gemini">
      <defs>
        <linearGradient id="geminiLogoGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#1A73E8" />
          <stop offset="50%" stop-color="#8AB4F8" />
          <stop offset="100%" stop-color="#9333EA" />
        </linearGradient>
      </defs>
      <path fill="url(#geminiLogoGrad2)" d="M12 0C12 6.63 6.63 12 0 12c6.63 0 12 5.63 12 12 0-6.63 5.63-12 12-12-6.63 0-12-5.63-12-12z"/>
    </svg>`;

  // 4. Microsoft Copilot (Official Cyan/Magenta Ribbon Gradient)
  const copilotSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Microsoft Copilot">
      <defs>
        <linearGradient id="copilotLogoGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#0078D4" />
          <stop offset="50%" stop-color="#00A4EF" />
          <stop offset="100%" stop-color="#EC4899" />
        </linearGradient>
      </defs>
      <path fill="url(#copilotLogoGrad2)" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 14.93V18h-2v-1.07A5.002 5.002 0 0 1 7.07 13H8v-2h-.93A5.002 5.002 0 0 1 11 7.07V6h2v1.07A5.002 5.002 0 0 1 16.93 11H16v2h.93A5.002 5.002 0 0 1 13 16.93zM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/>
    </svg>`;

  // 5. Cursor (Electric Cyan & Blue Isometric Cube)
  const cursorSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Cursor">
      <defs>
        <linearGradient id="cursorLogoGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#0EA5E9" />
          <stop offset="100%" stop-color="#3B82F6" />
        </linearGradient>
      </defs>
      <path fill="url(#cursorLogoGrad2)" d="M11.025.667L1.517 6.155A2.32 2.32 0 00.358 8.163v10.978c0 .83.442 1.597 1.159 2.008l9.508 5.488a2.32 2.32 0 002.32 0l9.508-5.488a2.32 2.32 0 001.159-2.008V8.163a2.32 2.32 0 00-1.159-2.008L13.345.667a2.32 2.32 0 00-2.32 0z"/>
    </svg>`;

  // 6. Perplexity AI (Official Teal #20B2AA / #13B5B1 Asterisk)
  const perplexitySvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" fill="#13B5B1" title="Perplexity AI">
      <path d="M12 2a1.5 1.5 0 0 0-1.5 1.5V9H5.5A1.5 1.5 0 0 0 4 10.5v3A1.5 1.5 0 0 0 5.5 15H10.5v5.5a1.5 1.5 0 0 0 3 0V15h5a1.5 1.5 0 0 0 1.5-1.5v-3A1.5 1.5 0 0 0 18.5 9H13.5V3.5A1.5 1.5 0 0 0 12 2z"/>
      <circle cx="12" cy="12" r="2.5" fill="#ffffff"/>
    </svg>`;

  // 7. Meta Llama (Official Meta Blue #0668E1 Infinity)
  const metaLlamaSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" fill="#0668E1" title="Meta Llama">
      <path d="M12 6.5C8.4 6.5 5.5 8.9 4.1 12c1.4 3.1 4.3 5.5 7.9 5.5s6.5-2.4 7.9-5.5C18.5 8.9 15.6 6.5 12 6.5zm0 9c-1.9 0-3.5-1.6-3.5-3.5S10.1 8.5 12 8.5s3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5z"/>
    </svg>`;

  // 8. Mistral AI (Official Orange Gradient #FF7000 / #FF4500)
  const mistralSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Mistral AI">
      <defs>
      ...
      <rect x="3" y="4" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
      <rect x="9.5" y="4" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
      <rect x="16" y="4" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
      <rect x="9.5" y="10" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
      <rect x="3" y="16" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
      <rect x="16" y="16" width="5" height="5" rx="1.5" fill="url(#mistralGrad)"/>
    </svg>`;

  // 9. Hugging Face (Official Yellow/Amber #FFD21E Emblem)
  const huggingFaceSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Hugging Face">
      <circle cx="12" cy="12" r="10" fill="#FFD21E"/>
      <circle cx="9" cy="10" r="1.5" fill="#1C1917"/>
      <circle cx="15" cy="10" r="1.5" fill="#1C1917"/>
      <path d="M8 14.5c1.2 1.8 4.8 1.8 6 0" stroke="#1C1917" stroke-width="1.8" stroke-linecap="round" fill="none"/>
    </svg>`;

  // 10. Model Context Protocol / MCP (Official Purple #8B5CF6 Network)
  const mcpSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="Model Context Protocol">
      <circle cx="12" cy="12" r="9.5" fill="#f5f3ff" stroke="#8B5CF6" stroke-width="2"/>
      <circle cx="12" cy="7" r="2.2" fill="#8B5CF6"/>
      <circle cx="7" cy="15" r="2.2" fill="#8B5CF6"/>
      <circle cx="17" cy="15" r="2.2" fill="#8B5CF6"/>
      <path d="M12 9.2v3.2m-3.2 1.4l3.2-1.4 3.2 1.4" stroke="#8B5CF6" stroke-width="1.8" stroke-linecap="round"/>
    </svg>`;

  // 11. DeepSeek (Official Blue/Cyan Wave #1E88E5 / #00ACC1)
  const deepseekSvg = `
    <svg viewBox="0 0 24 24" width="28" height="28" title="DeepSeek">
      <defs>
      ...
      <path fill="url(#deepseekGrad)" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
    </svg>`;
            ...
            <div class="channel-img-box ai-agents-box">
              <div class="ai-logos-flow">
                ...
                <div class="ai-row-bot">
                  <div class="ai-brand-item" title="Meta Llama">${metaLlamaSvg}</div>
                  ...
                  <div class="ai-brand-item" title="DeepSeek">${deepseekSvg}</div>
                </div>
              </div>
